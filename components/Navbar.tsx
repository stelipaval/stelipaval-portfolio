            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center">
                        ...
                        >
                            <span className="text-3xl font-bold text-gray-800 group-hover:text-cyan-600 transition-colors duration-300  font-bonheur-royale px-[10px]">
                                &lt; Stelica Paval /&gt;
                            </span>
                        </Link>
                    </div>
                    ...
                    <div className="md:hidden flex items-center">
                        ...
                        >
                            ...
                            <div className="w-6 h-6 relative">
                                <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-all duration-300 ${isMenuOpen ? 'rotate-45' : '-translate-y-1.5'
                                    } w-6 h-0.5 bg-current`}></div>
                                <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-all duration-300 ${isMenuOpen ? 'opacity-0' : ''
                                    } w-6 h-0.5 bg-current`}></div>
                                <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-all duration-300 ${isMenuOpen ? '-rotate-45' : 'translate-y-1.5'
                                    } w-6 h-0.5 bg-current`}></div>
                            </div>
